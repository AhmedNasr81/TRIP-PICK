...
export function ProgramCard({ program }: ProgramCardProps) {
  ...
  // Local optimistic state — overrides prop until mutation settles
      ...
      <Card className="overflow-hidden cursor-pointer group hover-elevate transition-all duration-300 h-full flex flex-col border-border/50 hover:border-primary/30">
        <div className="relative h-48 sm:h-56 overflow-hidden">
          ...
          <motion.button
            ...
            className="absolute top-3 right-3 bg-background/80 backdrop-blur-sm rounded-full p-1.5 shadow disabled:opacity-60 disabled:cursor-not-allowed"
